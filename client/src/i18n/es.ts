export const es = {
  ...
  evento: {
    ...
    v2: {
      ...
      sinSenal: "Sin señal",
      raidVeteranoX2: "Daño x2 · Cazador veterano",
      raidVeteranoProgreso: "Veterano: {n}/4 ataques · desde el 5.º tu daño se duplica",
      raidBonusX2: "(x2 veterano)",
      raidTrampa: "El Sistema detectó un auto clicker. Este ataque no cuenta.",
      raidCombo: "Combo",
      raidTiempo: "¡TIEMPO!",
  ...
  prensa: {
    seoTitulo: "Rueda de prensa — Isekai World Fest 2027",
    ...
    confirmadoTitulo: "Asistencia confirmada",
    confirmadoTexto: "Le esperamos el sábado 7 de noviembre a las 4:30 p. m. Recuerde traer su invitación física: es su pase de entrada.",
    calendario: "Agregar al calendario",
    comoLlegar: "Cómo llegar",
    limite: "No pudimos registrar más confirmaciones desde esta red por hoy. Inténtelo más tarde.",
    error: "No se pudo confirmar su asistencia. Inténtelo de nuevo.",
    accesoEtq: "Importante",
    accesoTitulo: "Acceso exclusivo con invitación física",
    accesoTexto: "El ingreso es únicamente presentando la invitación impresa que recibió. Llévela consigo: sin ella no será posible acceder a la rueda de prensa.",
    agendaEtq: "[ Lo que se revelará ]",
    agendaTitulo: "Una tarde que marcará el inicio",
    agenda1Titulo: "La presentación oficial",
    agenda1Texto: "El proyecto completo de Isekai World Fest 2027, contado por primera vez por quienes lo están construyendo.",
    agenda2Titulo: "Anuncios exclusivos",
    agenda2Texto: "Revelaciones que se harán públicas en esta rueda de prensa antes que en cualquier otro lugar.",
    agenda3Titulo: "Expositores y aliados",
    agenda3Texto: "Cómo formar parte del evento: stands, alianzas y beneficios para quienes den el primer paso.",
    agenda4Titulo: "Encuentro con la comunidad",
