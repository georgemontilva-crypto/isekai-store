          ...
          <div className="flex flex-col justify-between p-7 border-l border-[#f0f0f0]">
            <div>
              ...
              <div className="w-full h-1 bg-[#f0f0f0] rounded-full mb-4">
                <div className="h-full bg-[#111] rounded-full" style={{ width: '20%' }} />
              </div>
            </div>
            ...
            <div>
              <button
                ...
                className="w-full flex items-center justify-between bg-[#111] text-white font-semibold text-[14px] px-6 py-4 rounded-full hover:bg-[#333] transition-colors mb-3 active:scale-[0.98]"
              >
