...
export function PopupManager({ productId }: { productId?: number }) {
  ...
  const isCenter = activePopup.position === 'center' || !activePopup.position;
  ...
  return (
    <div className={positionClasses[activePopup.position ?? 'center']}>
      {isCenter && (
        <div
      ...
      <div className={`relative bg-white rounded-2xl shadow-2xl overflow-hidden
        ${isCenter ? 'w-full max-w-md' : 'w-[320px]'}`}>
