...
const PAGES: PageGroup[] = [
  ...
  {
    page: "Vitrinas de categoría",
    slots: [
      { kind: "site", key: "showcase_1_image", label: "Vitrina 1 — imagen",
        where: "Imagen cuadrada a la izquierda de la vitrina 1.",
        spec: "Cuadrada, ~1000 × 1000 px (1:1). Deja espacio abajo para el botón." },
      { kind: "site", key: "showcase_1_image_mobile", label: "Vitrina 1 — imagen móvil",
        where: "Reemplaza a la anterior en teléfono. Vacío = se usa la misma.",
        spec: "Cuadrada, ~1000 × 1000 px." },
      { kind: "site", key: "showcase_2_image", label: "Vitrina 2 — imagen",
        where: "Imagen cuadrada a la izquierda de la vitrina 2.",
        spec: "Cuadrada, ~1000 × 1000 px (1:1). Deja espacio abajo para el botón." },
      { kind: "site", key: "showcase_2_image_mobile", label: "Vitrina 2 — imagen móvil",
        where: "Reemplaza a la anterior en teléfono. Vacío = se usa la misma.",
        spec: "Cuadrada, ~1000 × 1000 px." },
      { kind: "site", key: "showcase_3_image", label: "Vitrina 3 — imagen",
        where: "Imagen cuadrada a la izquierda de la vitrina 3.",
        spec: "Cuadrada, ~1000 × 1000 px (1:1). Deja espacio abajo para el botón." },
      { kind: "site", key: "showcase_3_image_mobile", label: "Vitrina 3 — imagen móvil",
        where: "Reemplaza a la anterior en teléfono. Vacío = se usa la misma.",
        spec: "Cuadrada, ~1000 × 1000 px." },
    ],
  },
