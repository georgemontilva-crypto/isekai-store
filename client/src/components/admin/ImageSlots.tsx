...
const PAGES: PageGroup[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { kind: "site", key: "wf_galeria_1", label: "Galería conceptual 1",
        where: "Sección «No te imagines el mundo, míralo» de la landing del evento.",
        spec: "Vertical 4:5, ~800 × 1000 px." },
      { kind: "site", key: "wf_galeria_2", label: "Galería conceptual 2",
        where: "Sección «No te imagines el mundo, míralo» de la landing del evento.",
        spec: "Vertical 4:5, ~800 × 1000 px." },
      { kind: "site", key: "wf_galeria_3", label: "Galería conceptual 3",
        where: "Sección «No te imagines el mundo, míralo» de la landing del evento.",
        spec: "Vertical 4:5, ~800 × 1000 px." },
      { kind: "site", key: "wf_galeria_4", label: "Galería conceptual 4",
        where: "Sección «No te imagines el mundo, míralo» de la landing del evento.",
        spec: "Vertical 4:5, ~800 × 1000 px." },
      { kind: "site", key: "wf_galeria_5", label: "Galería conceptual 5",
        where: "Sección «No te imagines el mundo, míralo» de la landing del evento.",
        spec: "Vertical 4:5, ~800 × 1000 px." },
      { kind: "site", key: "wf_galeria_6", label: "Galería conceptual 6",
        where: "Sección «No te imagines el mundo, míralo» de la landing del evento.",
        spec: "Vertical 4:5, ~800 × 1000 px." },
