...
export default function Home() {
  ...
  return (
    <div className="bg-white text-[#1a1a1a]">
      ...
      ══════════════════════════════════════════════ */}
      {/* Outer wrapper: video takes full height, product card overlaps from below */}
        ...
        {featuredProduct && (
          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-[80px_1fr_1fr] gap-0" style={{ minHeight: 380 }}>
                {/* Thumbnails column */}
                <div className="flex flex-col gap-2 p-4 border-r border-[#f0f0f0]">
                  {[
                    featuredProduct.imageUrl ?? 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=200&q=80',
                    ...
                    <div
                      ...
                      style={{ border: ti === 0 ? '2px solid #1a1a1a' : '2px solid transparent', background: '#f5f5f5' }}
                    >
                ...
                {/* Main image */}
                <div className="relative bg-[#f7f7f7] flex items-center justify-center overflow-hidden">
                  <img
                    src={featuredProduct.imageUrl ?? 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=800&q=80'}
                ...
                <div className="flex flex-col justify-between p-7 border-l border-[#f0f0f0]">
                  <div>
                    ...
                    <div className="flex items-start justify-between gap-4 mb-2">
                      <h3 className="text-[26px] font-black text-[#1a1a1a] leading-tight">{featuredProduct.name}</h3>
                    ...
                    <div className="mb-4">
                      <p className="text-[12px] font-medium text-[#1a1a1a] mb-2">Color: <span className="font-normal text-[#555]">Default</span></p>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <span className="text-white/70">— &nbsp;${parseFloat(featuredProduct.price).toFixed(2)}</span>
                    </button>
                    {/* Trust badges */}
