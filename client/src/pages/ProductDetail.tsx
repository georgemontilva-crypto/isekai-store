    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/catalog" className="mt-4 inline-block bg-[#111] text-white text-sm font-semibold px-6 py-3 rounded-full hover:bg-[#333] transition-colors">
            Volver al catálogo
          </Link>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="relative aspect-square rounded-2xl overflow-hidden bg-[#f5f5f5]">
              ...
              <div className="absolute top-3 left-3 flex flex-col gap-1.5 z-10">
                {hasDiscount && (
                  <span className="bg-[#111] text-white text-[10px] font-bold px-2.5 py-1 rounded-full leading-none">
                    -{discountPct}%
                  </span>
                )}
          ...
          >
                    ...
                    return (
                      <button
                        ...
                        className={`relative px-4 py-2.5 rounded-xl text-sm font-medium border-2 transition-all duration-200 ${
                          isSelected
                            ? "border-[#1a1a1a] bg-[#111] text-white"
                            : variant.stock <= 0
            ...
            <button
              ...
              disabled={isOutOfStock || adding || buying}
              className="w-full mt-3 bg-white text-[#1a1a1a] font-semibold text-[15px] py-4 rounded-full border-2 border-[#1a1a1a] hover:bg-[#1e1e1e] hover:text-white transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {adding ? (
                <>
